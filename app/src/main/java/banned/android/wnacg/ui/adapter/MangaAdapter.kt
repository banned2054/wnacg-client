...
class MangaAdapter(private var list: List<Manga>, private var imageDao: ImageDao, private var imageRepository: ImageRepository) : RecyclerView.Adapter<MangaAdapter.MyViewHolder>()
{
